...
**Download the app:** [d10-padel-scoreboard.apk](https://github.com/norom/d10_padel/releases/download/v1.11/d10-padel-scoreboard.apk) — the version the remote can drive
